...
class HTMLFormElement extends HTMLElement {
    ...
    get action() {
        ...
        try {
            return new URL(this.getAttribute('action') || '', this[PropertySymbol.ownerDocument].location.href).href;
        }
        catch (e) {
            return '';
        }
     ...
     * @param name Name
     */
    [(_HTMLFormElement_browserFrame = new WeakMap(), _HTMLFormElement_instances = new WeakSet(), _a = PropertySymbol.elements, _b = PropertySymbol.length, _c = PropertySymbol.formNode, PropertySymbol.appendFormControlItem)](node, name) {
