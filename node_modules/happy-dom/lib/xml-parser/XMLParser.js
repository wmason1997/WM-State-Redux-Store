                    ...
                    case MarkupReadStateEnum.startOrEndTag:
                        ...
                        if (match[1]) {
                            ...
                            const namespaceURI = tagName === 'SVG'
                                ? NamespaceURI.svg
                                : currentNode[PropertySymbol.namespaceURI] || NamespaceURI.html;
                    ...
                    case MarkupReadStateEnum.insideStartTag:
                        ...
                        if (match[7] || match[8]) {
                            ...
                            if (!!attributeString) {
                                ...
                                while ((attributeMatch = attributeRegexp.exec(attributeString))) {
                                    if ((attributeMatch[1] && attributeMatch[2]) ||
                                        ...
                                        const namespaceURI = currentNode[PropertySymbol.namespaceURI] === NamespaceURI.svg &&
                                            name === 'xmlns'
                                            ? NamespaceURI.xmlns
                                            : null;
                            ...
                            if (hasAttributeStringEnded) {
                                ...
                                if (HTMLElementVoid[currentNode[PropertySymbol.tagName]] ||
                                    (match[7] &&
                                        currentNode[PropertySymbol.namespaceURI] === NamespaceURI.svg)) {
                                    stack.pop();
                                    currentNode = stack[stack.length - 1] || root;
                                    ...
                                    plainTextTagName = HTMLElementPlainText[currentNode[PropertySymbol.tagName]]
                                    ...
                                    if (HTMLElementUnnestable[currentNode[PropertySymbol.tagName]]) {
