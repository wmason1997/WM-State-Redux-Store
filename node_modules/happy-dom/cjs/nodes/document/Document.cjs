...
const HTMLElementLocalNameToClass_js_1 = __importDefault(require("../../config/HTMLElementLocalNameToClass.cjs"));
...
class Document extends Node_js_1.default {
    ...
    createElementNS(namespaceURI, qualifiedName, options) {
        ...
        const elementClass = this[PropertySymbol.ownerWindow][HTMLElementLocalNameToClass_js_1.default[localName]];
        // Known HTML element
        if (elementClass) {
