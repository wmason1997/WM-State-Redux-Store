...
class Fetch {
     ...
     */
    async send() {
        FetchRequestReferrerUtility_js_1.default.prepareRequest(new URL_js_1.default(__classPrivateFieldGet(this, _Fetch_window, "f").location.href), this.request);
     ...
     */
    abort(reason) {
        const error = new DOMException_js_1.default('The operation was aborted.' + (reason ? ' ' + reason : ''), DOMExceptionNameEnum_js_1.default.abortError);
        if (this.nodeRequest && !this.nodeRequest.destroyed) {
            this.nodeRequest.destroy(error);
        }
        if (this.nodeResponse && !this.nodeResponse.destroyed) {
